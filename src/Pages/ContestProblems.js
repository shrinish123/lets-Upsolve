...
export const ContestProblems = ({ contestName, contestProblems, solvedProblems}) => {
  console.log(contestName);
  console.log(contestProblems);
  let problems = contestProblems;
  let solvedProblemsInContest = solvedProblems;
            ...
            <TableBody>
              ...
              {problems
                ...
                .map((problem, index) => {
                  ...
                  let bgColor = "";
                  if(solvedProblemsInContest.findIndex(solvedProblem => problemCode===solvedProblem)!==-1) bgColor = "#b4e4c9";
                  return (
                    <TableRow
                      hover
